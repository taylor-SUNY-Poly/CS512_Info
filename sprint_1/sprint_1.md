...
**Total backlog hours (start):** 116 (not all hours shown here for brevity in this example doc...)
...
line "Ideal" [31,27,23,19,15,11,7,0]
line "Actual" [31,29,26,22,20,14,8,0]
```
